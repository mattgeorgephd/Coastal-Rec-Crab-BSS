...
| PE vs BSS | `pe_port_summary.csv`, `pe_vs_bss_comparison.csv`, `monthly_pe_vs_bss.csv` | Point Estimator results and the side-by-side reconciliation used by the convergence gate. 2026-09-08+: the census row's `method_selected` states the observed / imputed split and the imputation SE. |
