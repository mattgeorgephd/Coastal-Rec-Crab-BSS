...
**Status 2026-08-31: DONE. ANSWERED: the two levers are ADDITIVE (interaction -155 against main effects of +5,140 and +11,491), and calibration says adopt one and not the other.** See `stage5-batch-review-2026-08-31.md` section 1. The shared turnover buys 14.7 nats of trailer elpd for 3.1 effective parameters and moves every calibration statistic toward nominal; the daily AR spends 27-48 effective parameters on 195 observations, makes the catch stream 3.8 nats worse in BOTH tau conditions, produces 2 then 16 Pareto k above 0.7, and pushes OSP `coverage_50` to 0.93-0.98 against a nominal 0.50. The S4a correction below was worth making and returned a clean null: the matched cell gives 37,359, identical to stage F, because fits are independent and `ar_escalate` settled the boat at daily on its first attempt.
