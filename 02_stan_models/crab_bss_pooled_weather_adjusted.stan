...
//
// v6.9 (B1.7) ATTEMPTED AND REVERTED (2026-06-21). The single-cell scale collapse
//   (matching crab_bss_pooled.stan) made the shore all-gear fit hang via
//   max_treedepth saturation when the level had to reconcile directly against the
//   289-state daily AR. The hierarchy is restored here too. See crab_bss_pooled.stan
//   and documentation Section 14.
// =============================================================================
