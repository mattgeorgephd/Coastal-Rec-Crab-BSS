...
Per-model technical documentation is in `07_documentation/` (`BSS-GH-pooled-CPUE-model-documentation.md` (Method v2.0), `BSS-GH-gear-type-CPUE-model-documentation.md`, `BSS-GH-pooled-CPUE-weather-tide-covariates-documentation.md`).
